...
export const getInstagramEmbedUrl = (url: string): string | null => {
    ...
    // Handle Reels, Posts, and TV links
    // e.g. https://www.instagram.com/p/CODE/
    // or https://www.instagram.com/reel/CODE/

    try {
        const urlObj = new URL(url);
        let path = urlObj.pathname;

        // Ensure path starts with /p/ or /reel/ or /reels/ or /tv/
        ...
        // Extract the code (the part after /p/ or /reel/)
